...
exports.create = function(streamOrOptions){
	var socket = new Socket(streamOrOptions);
	return socket;
};
...
var Socket = exports.Socket = function(streamOrOptions){
	var self = this;
	
	if(streamOrOptions instanceof net.Socket || streamOrOptions instanceof tls.constructor){
		this._socket = streamOrOptions;
	} else {
		streamOrOptions = streamOrOptions || {};
		this._socket = new net.Socket(streamOrOptions);
	}
